      ...
      <section className='pt=0'>
        <Container>
          <Row>
            ...
            <Col lg='6'>
              <div className="product_deatails">
                <h2>{productName}</h2>
                <div className="produtc_rating d-flex align-items-center gap-5 mb-3">
                  <div>
        ...
        <Container>
          <Row>
            ...
            <div className="tab_wrapper d-flex align-items-center gap-5">
             ...
             {
                tab==='desc'?
                <div className="tab_content mt-5"><p>{description}</p></div>:
                      ...
                      <form action="" onSubmit={submitHandler}>
                        ...
                        <div className="form_group d-flex
                         align-items-center gap-5 rating_group">
                          ...
                          <motion.span whileTap={{scale:1.1}} onClick={()=>setRating(5)}>5<i class="ri-star-s-fill"></i></motion.span>  
                        </div>
                        <div className="form_group">
                          <textarea ref={reviewMsg} rows={4} type="text"
